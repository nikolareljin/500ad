...
**Version 1.18.0** - Adds comprehensive performance optimizations for large worlds including profiling tools, render caching, viewport-buffered batched rendering, and AI processing improvements.
